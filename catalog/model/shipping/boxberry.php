        ...
        if (false !== strpos($deliveryType, 'pickup')) {
            ...
            try {
                ...
                return [
                    ...
                    'tax_class_id' => 0,
                    'text' => $this->currency->format($this->tax->calculate($costData->getTotalPricePickup(), 0, $this->config->get('config_tax')), $this->config->get('config_currency')) . $deliveryPeriodText,
                    'boxberry_description' => $htmlBlock . $htmlLink
                ];
